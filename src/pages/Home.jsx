      ...
      <section className="glass-panel" style={{
        ...
        <div>
          <h3 style={{ fontSize: '48px', fontFamily: 'var(--font-title)', fontWeight: 800, color: 'var(--accent-primary)' }}>
            {stats?.organizedTournaments || '114'}
          </h3>
      ...
      <section style={{
        ...
        <div className="glass-panel" style={{ padding: '0', overflow: 'hidden', height: '360px', position: 'relative', borderRadius: '20px' }}>
          ...
          <div style={{
            ...
            }}>Yaklaşan İlk Etkinlik</span>
            <h3 style={{ fontFamily: 'var(--font-title)', fontSize: '24px', fontWeight: 700, marginTop: '12px' }}>
              114. Tilda Cafe Satranç 15+3 Buluşması
            </h3>
            <p style={{ color: 'var(--text-secondary)', fontSize: '14px', marginTop: '6px' }}>
              📅 08 Ağustos Cumartesi, 15:00 <br />
              📍 Ümraniye Tilda Cafe
            </p>
          </div>
          <div style={{
          ...
          {/* Decorative Chess Pieces SVG Backdrop */}
          <div style={{
            display: 'flex',
        ...
        <div style={{
          ...
          {topThree[0] && (
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '180px', transform: 'scale(1.05)' }}>
              ...
              <div style={{
                background: 'linear-gradient(to top, rgba(16, 185, 129, 0.2), rgba(139, 92, 246, 0.2))',
                ...
                <span style={{ fontSize: '12px', color: 'var(--accent-primary)' }}>{topThree[0].titles} Kupa</span>
              </div>
            </div>
          )}
